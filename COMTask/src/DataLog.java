...
public class DataLog {
	...
	public String generateLog(){
		String s = "TrialNum,RunType,AspectRatio,UpDown,InitialPosition,Base,Height,ActualCOM_Y,Response\n";
		...
		for (int i=0; i<numTrials; i++){
			...
			s += d.getInitialPosition() == true? "Down,": "Up,";
			...
			s += Integer.toString(d.getTrueValue());
			s += ",";
