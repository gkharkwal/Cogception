...
<head>
	<title>Tone Discrimination Experiment</title>
</head>
...
<center>
<h3> Tone Discrimination Experiment - Data</h3>
<br/><hr/>
<br/>
...
if($_SESSION['role'] == 'Instructor'){
	...
	while (false !== ($user = readdir($h1))) {
		...
		$path = '../../data/'.str_replace(':','-',$_SESSION['secid']).'/'.$user.'/ToneDiscrimination/';
	...
	$path = '../../data/'.str_replace(':','-',$_SESSION['secid']).'/'.$_SESSION['id'].'/ToneDiscrimination/';
