...
<head>
	<title>Category Learning Experiment</title>
</head>
...
<center>
<h3> Category Learning Experiment - Data</h3>
<br/><hr/>
<br/>
...
if($_SESSION['role'] == 'Instructor'){
	...
	while (false !== ($user = readdir($h1))) {
		...
		$path = '../../data/'.str_replace(':','-',$_SESSION['secid']).'/'.$user.'/Categorization/';
	...
	$path = '../../data/'.str_replace(':','-',$_SESSION['secid']).'/'.$_SESSION['id'].'/Categorization/';
