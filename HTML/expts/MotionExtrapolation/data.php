...
<center>
<h3> Motion Extrapolation Experiment - Data</h3>
<br/><hr/>
<br/>
...
if($_SESSION['role'] == 'Instructor'){
	...
	while (false !== ($user = readdir($h1))) {
		...
		$path = '../../data/'.str_replace(':','-',$_SESSION['secid']).'/'.$user.'/MotionExtrapolation/';
	...
	$path = '../../data/'.str_replace(':','-',$_SESSION['secid']).'/'.$_SESSION['id'].'/MotionExtrapolation/';
