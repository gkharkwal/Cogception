...
<head>
	<title>COM Estimation Experiment</title>
</head>
...
<center>
<h3> COM Estimation Experiment - Data</h3>
<br/><hr/>
<br/>
...
if($_SESSION['role'] == 'Instructor'){
	...
	while (false !== ($user = readdir($h1))) {
		...
		$path = '../../data/'.str_replace(':','-',$_SESSION['secid']).'/'.$user.'/COMTask/';
	...
	$path = '../../data/'.str_replace(':','-',$_SESSION['secid']).'/'.$_SESSION['id'].'/COMTask';
