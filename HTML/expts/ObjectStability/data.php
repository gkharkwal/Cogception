...
<head>
	<title>Object Stability Experiment</title>
</head>
...
<center>
<h3> Object Stability Experiment - Data</h3>
<br/><hr/>
<br/>
...
if($_SESSION['role'] == 'Instructor'){
	...
	while (false !== ($user = readdir($h1))) {
		...
		$path = '../../data/'.str_replace(':','-',$_SESSION['secid']).'/'.$user.'/ObjectStability/';
	...
	$path = '../../data/'.str_replace(':','-',$_SESSION['secid']).'/'.$_SESSION['id'].'/ObjectStability/';
